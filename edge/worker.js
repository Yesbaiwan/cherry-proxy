...
async function generateSignatureHeaders({ method, path, body = null }) {
...
function openaiError(message, statusCode, errorType, code = null) {
  const body = { error: { message, type: errorType } };
...
function handleStreamResponse(upstreamResp) {
